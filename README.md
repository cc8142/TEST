...
- Browser UI (Playwright): `python -m playwright install`
...
## Notes
- Playwright is included in base deps; run `python -m playwright install` once for browsers. Use `ui_contract` for no-browser checks.
